...
const DOCS_OPT = [
  ...
  { key: 'notas_anteriores', label: 'Notas Centro Educativo anterior' },
]
  ...
  return (
    <div className="min-h-screen bg-[#FDF8F3]">
      ...
      <main className="max-w-lg mx-auto p-4 pb-32 space-y-5">
        ...
        {pa.observaciones_admin && (
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
            <div className="flex items-start gap-2">
              ...
              <div>
                <h3 className="text-sm font-bold text-amber-800 mb-1">Observación del Centro Educativo</h3>
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          <label className="text-[11px] font-semibold text-gray-600 mb-1 block">Respuesta al Centro Educativo (opcional)</label>
