    ...
    <div className="min-h-screen bg-papel papel-rayado flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="flex items-center gap-3 mb-8 justify-center">
          <div className="w-14 h-14 bg-azul rounded flex items-center justify-center">
            <span className="font-playfair font-black text-white text-xl tracking-tight">AR</span>
          </div>
          <div>
            <div className="font-playfair font-bold text-2xl text-tinta">AR School</div>
        ...
        <div className="card p-8">
          <div className="border-l-4 border-rojo pl-4 mb-6">
            ...
            <p className="text-sm text-tinta-s italic mt-1">Accede con tu cuenta de AR School Global</p>
          </div>
        ...
        <p className="text-center font-mono text-xs text-tinta-s mt-6">
          AR School Global · Fundacion ARM Global
        </p>
      </div>
    </div>
  )
