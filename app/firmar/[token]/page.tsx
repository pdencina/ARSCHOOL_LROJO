    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FDF8F3] p-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-gray-500">Este enlace de firma no existe o ya no está disponible. Contacte al colegio para solicitar uno nuevo.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FDF8F3] p-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-gray-500">Este documento ya fue firmado exitosamente. El colegio tiene registro de su firma.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FDF8F3] p-4">
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-sm text-gray-500">Este enlace ha expirado. Contacte al colegio para que le envíen uno nuevo.</p>
        </div>
      </div>
    )
  }
